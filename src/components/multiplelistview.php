    ...
    <div class="app-container">
        ...
        <div class="listview mb-4">
            ...
            <a href="javascript:void(0);" class="listview-item nested-trigger" data-target="s2-link">
                <div class="col"><img src="https://placehold.co/36" class="rounded-circle"> <strong>Link List</strong>
                </div>
            </a>
            ...
            <a href="javascript:void(0);" class="listview-item nested-trigger" data-target="s2-simple">
                <div class="col"><img src="https://placehold.co/36" class="rounded-circle"> <strong>Simple List</strong>
                </div>
            </a>
            ...
            <a href="javascript:void(0);" class="listview-item nested-trigger" data-target="s2-imaged">
                <div class="col"><img src="https://placehold.co/36" class="rounded-circle"> <strong>Imaged List</strong>
                </div>
            </a>
            ...
            <a href="javascript:void(0);" class="listview-item nested-trigger" data-target="s2-iconed">
                <div class="col"><img src="https://placehold.co/36" class="rounded-circle"> <strong>Iconed List</strong>
                </div>
            </a>
            ...
            <a href="javascript:void(0);" class="listview-item nested-trigger" data-target="s2-media">
                <div class="col"><img src="https://placehold.co/36" class="rounded-circle"> <strong>Media List</strong>
                </div>
            </a>
        ...
        <div class="listview mb-4">
            ...
            <a href="javascript:void(0);" class="listview-item nested-trigger px-3" data-target="s3-link">
                <div class="col">
                    <div class="bg-primary px-2 py-1 rounded-circle"><i class="bi bi-share text-white"></i></div>
            ...
            <a href="javascript:void(0);" class="listview-item nested-trigger px-3" data-target="s3-simple">
                <div class="col">
                    <div class="bg-danger px-2 py-1 rounded-circle"><i class="bi bi-broadcast text-white"></i></div>
            ...
            <a href="javascript:void(0);" class="listview-item nested-trigger px-3" data-target="s3-imaged">
                <div class="col">
                    <div class="bg-success px-2 py-1 rounded-circle"><i class="bi bi-card-image text-white icon"></i>
                    </div> <strong>Imaged List</strong>
                </div>
            </a>
            ...
            <a href="javascript:void(0);" class="listview-item nested-trigger px-3" data-target="s3-iconed">
                <div class="col">
                    <div class="bg-warning px-2 py-1 rounded-circle"><i class="bi bi-emoji-smile text-white"></i></div>
                    <strong>Iconed List</strong>
                </div>
            </a>
            ...
            <a href="javascript:void(0);" class="listview-item nested-trigger px-3" data-target="s3-media">
                <div class="col">
                    <div class="bg-info px-2 py-1 rounded-circle"><i class="bi bi-collection text-white"></i></div>
